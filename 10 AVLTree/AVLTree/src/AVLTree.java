...
//
//        if (balanceFactor >= 2 && getBalanceFactor(retNode.left) < 0) {
//            System.out.println("-----1----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            retNode.left = leftRotate(retNode.left);
//        }
//        if (balanceFactor >= 2 && getBalanceFactor(retNode.left) >= 0)
//        {
//            System.out.println("-----2----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            retNode = rightRotate(retNode);
//            System.out.println("-----2 result----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            return retNode;
//        }
//
//        if (balanceFactor <= -2 && getBalanceFactor(node.right) > 0) {
//            System.out.println("-----3----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            retNode.right = rightRotate(retNode.right);
//        }
//        if (balanceFactor <= -2 && getBalanceFactor(retNode.right) <= 0)
//        {
//            System.out.println("-----4----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            retNode = leftRotate(retNode);
//            System.out.println("----4 result----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//            return retNode;
//        }
//
//        System.out.println("-----result----"+"node: "+balanceFactor + " left: "+ getBalanceFactor(retNode.left) + " right: "+ getBalanceFactor(retNode.right));
//        System.out.println("-------end--------\n");
    ...
    // 从二分搜索树中删除键为key的节点
    /*public V remove_BST_teacher(K key){
    ...
    private Node remove_BST_teacher(Node node, K key){
